            ...
            <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden">
                ...
                {isConnected && (
                    <div className="absolute inset-0 z-10">
                        ...
                        {/* Vision Label */}
                        <div className="absolute top-12 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-black/60 px-4 py-1 rounded-full border border-cyan-500/30 backdrop-blur-md">
